...
public class StringPatternFormatter {
...
extension StringPatternFormatter {
    ...
    private func processReplace(in attributedString: inout NSMutableAttributedString, patternToBeReplaced: String, replacingString: String) throws {
    ...
    private func processAttributedKey(in attributedString: inout NSMutableAttributedString, pattern: String, attributes: [NSAttributedString.Key : Any]) throws {
    ...
    private func applyAttributes(_ attributes: [NSAttributedString.Key : Any], to attributedString: inout NSMutableAttributedString, in result: NSTextCheckingResult) throws {
